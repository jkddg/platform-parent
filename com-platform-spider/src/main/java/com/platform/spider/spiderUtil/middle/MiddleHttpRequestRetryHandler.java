...
public class MiddleHttpRequestRetryHandler implements HttpRequestRetryHandler {

    public static final MiddleHttpRequestRetryHandler INSTANCE = new MiddleHttpRequestRetryHandler();
     ...
     * @since 4.3
     */
    protected MiddleHttpRequestRetryHandler(
    ...
    public MiddleHttpRequestRetryHandler(final int retryCount, final boolean requestSentRetryEnabled) {
     ...
     * </ul>
     */
    public MiddleHttpRequestRetryHandler() {
        this(3, false);
    }
