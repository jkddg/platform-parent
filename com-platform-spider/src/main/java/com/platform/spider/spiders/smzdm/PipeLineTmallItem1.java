...
/**
 * Created by Huangyonghao on 2019/9/26 15:08.
 */
public class PipeLineTmallItem1 extends ResponsePipeLine {
    ...
    public void processResponse(SpiderResponse response) {
        ...
        if (element != null) {
            ...
            new SpiderSmzdmTmallItem(url, response.getReferer(), new PipeLineTmallItem2());
        }
    }
}
